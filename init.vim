...
source ~/.config/nvim/plugin/plug-setting/vim-table-mode.vim
source ~/.config/nvim/plugin/plug-setting/NerdCommenter.vim
source ~/.config/nvim/plugin/plug-setting/asyncrun.vim
source ~/.config/nvim/plugin/plug-setting/vim-markdown.vim
